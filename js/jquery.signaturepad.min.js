(function (c) {
    function C(n, m) {
        ...
        function F(a, e, f) {
            ...
            a.drawInvalid && e.prepend(['<div class="alert alert-error">', f.errorMessageDraw, "</div>"].join(""))
        }
        function w() {
            var a = true,
                e = {
        ...
        var q = this,
            b = c.extend({}, c.fn.signaturePad.defaults, m),
            d = c(n),
            i = c(b.canvas, d),
            k = i.get(0),
            h = null,
    ...
    c.fn.signaturePad.defaults = {
        ...
        errorMessageDraw: "You did not enter a number!",
